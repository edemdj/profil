  ...
  return (
    ...
    >
      ...
      <div className="text-white px-4 py-16 text-center">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-gray-200 max-w-xs sm:max-w-md md:max-w-4xl mx-auto mb-8">
          Passionné par le développement web et les nouvelles technologies.
          Je crée des solutions innovantes et élégantes pour répondre aux besoins d'une collaboration.
        </p>
        <a
          href="#projects"
          className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 sm:px-6 py-3 rounded-full hover:bg-blue-700 active:scale-95 transition-transform duration-300"
        >
          Voir mes projets
