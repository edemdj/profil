  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        {/* Photo de profil */}
        <div className="relative overflow-hidden mx-auto mb-8 rounded-full shadow-2xl border-4 border-white transform hover:scale-105 transition-transform duration-500">
          <img
            src={photoProfil}
            alt="Photo de profil du développeur web Full Stack"
            className="w-56 h-56 sm:w-72 sm:h-72 lg:w-96 lg:h-96 object-cover"
            loading="lazy"
          />
        </div>
